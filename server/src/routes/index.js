...
router.use('/pricehistory', cors({ methods: 'GET' }), pricehistory)
router.use('/video', cors({ methods: 'GET' }), video)
router.use('/fabric', cors({ methods: 'GET, POST, PATCH, DELETE' }), fabric)

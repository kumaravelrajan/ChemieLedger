...
export const createRequest = async function(data) {
  return request({
    url: "/request",
    method: "post",
    data
...
export const deleteRequest = async function(id) {
  return request({
    url: "/request/" + id,
    method: "delete"
  });
...
export const getRequest = async function(id) {
  return request({
    url: "/request/" + id,
    method: "get"
  });
...
export const pushRequest = async function(id, data) {
  return request({
    url: "/request/" + id,
    method: "patch",
    data
...
export const uploadRequestImage = async function(requestId, data) {
  return request({
...
export const deleteImageFromRequest = async function(requestId, data) {
  return request({
...
export const getAvailableSubOrigins = async function(parentId) {
  return request({
...
export const getProductOffers = async function(productId) {
  return request({
...
export const getProductRequests = async function(productId) {
  return request({
...
export const getRequestCommunication = async function(requestId) {
  return request({
...
export const postCommunicationRequest = async function(requestId, data) {
  return request({
...
export const pushMessage = async function(communicationId, data) {
  return request({
...
export const sendMessageRead = async function(communicationId) {
  return request({
...
export const postCloseRequest = async function(requestId, data) {
  return request({
...
export const postCloseRequestWithoutDeal = async function(requestId) {
  return request({
...
export const getNicknameFromUserId = async function(userId) {
  return request({
...
export const addItemToWhatchlist = async function(id) {
...
export const removeItemFromWhatchlist = async function(id) {
  const data = { requestId: id };
  return request({
